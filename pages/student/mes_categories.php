...
$currentPage = 'mes_categories';
$pageTitle = 'Mes Catégories';
    ...
    <div class="bg-gradient-to-r from-green-500 to-emerald-600 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <h1 class="text-4xl font-bold mb-4">
                <i class="fas fa-th-list mr-3"></i>Mes Catégories
            </h1>
            <p class="text-xl text-green-100">Explorez les catégories de quiz disponibles</p>
        </div>
    </div>
